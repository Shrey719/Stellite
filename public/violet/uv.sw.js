// yuh i just ran prettier on a minified script 
// source is on the titanium network github
"use strict";
(() => {
    ...
    return `<!DOCTYPE html>
        <html>
            <head>
                ...
                <title>Error</title>
                <style>
                    body, html {margin: 0; height: 100%; width: 100%; padding: 0; border: none; overflow: hidden;}
                </style>
            </head>
        <body>
            <iframe src="/routeErr?err=${encodeURIComponent(a)}&url=${encodeURIComponent(e)}" height="100%" width="100%" style="margin: 0; padding: 0; border: none;"></iframe>
        </body>
        </html>
        `;
  }
